...
var KTDatatablesServerSide = function () {
                  ...
                  <a href="#" class="btn btn-primary btn-active-primary btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" data-kt-menu-flip="top-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-150px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                  <a href="#" class="menu-link px-3" data-kt-docs-table-filter="edit_row" id="edit_batch_btn" data-id="`+data.id+`" data-bs-toggle="modal" data-bs-target="#edit_batch_modal">
                                    Edit Batch
                                  </a>
                              </div>
                                <!--end::Menu item-->
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                      <a href="/list/batch?id=`+data.harvest_id+`&harvest_name=`+data.harvest_name+`&batch_id=`+data.id+`" class="menu-link px-3">
                                       Generate QR Code
                                      </a>
                                    </div>
                                    <!--end::Menu item-->
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                   <a href="#" id="delete_batch_btn" data-id="`+data.id+`" class="menu-link px-3" data-kt-docs-table-filter="delete_row">
                                        Delete Batch
                                    </a>
                                </div>
                                <!--end::Menu item-->
 ...
 var handleSearchDatatable = function () {
     const filterSearch = document.querySelector('#batchSearch');
...
KTUtil.onDOMContentLoaded(function () {
  ...
  jQuery(document).off('change', '#batchSearch');
  jQuery(document).on('change', '#batchSearch', function(e) {
    if($(this).val().length == 0){
      $("#batch_dt").DataTable().search($('#batchSearch').val()).draw();
    }
  });
