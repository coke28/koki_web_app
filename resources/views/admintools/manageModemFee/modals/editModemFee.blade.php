<div class="modal fade" id="editModemFee" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="editModemFee" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content" id="modemFeeModalContent">
            ...
            <div class="modal-body">
              ...
              <form class="form" id="edit_modem_fee_form">
              ...
              <div class="modal-footer">
                  ...
                  <button type="submit" id="editModemFeeSubmitBtn" class="btn btn-primary font-weight-bold">Edit Modem Fee</button>
              </div>
            </form>
        </div>
    </div>
