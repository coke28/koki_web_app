<div class="modal fade" id="editInstallationFee" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="editInstallationFee" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content" id="installationFeeModalContent">
            ...
            <div class="modal-body">
              ...
              <form class="form" id="edit_installation_fee_form">
              ...
              <div class="modal-footer">
                  ...
                  <button type="submit" id="editInstallationFeeSubmitBtn" class="btn btn-primary font-weight-bold">Edit Installation Fee</button>
              </div>
            </form>
        </div>
    </div>
