<div class="modal fade" id="editPhoneBrand" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="editPhoneBrand" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content" id="phoneBrandModalContent">
            ...
            <div class="modal-body">
              ...
              <form class="form" id="edit_phone_brand_form">
              ...
              <div class="modal-footer">
                  ...
                  <button type="submit" id="editPhoneBrandSubmitBtn" class="btn btn-primary font-weight-bold">Edit Phone Brand</button>
              </div>
            </form>
        </div>
    </div>
