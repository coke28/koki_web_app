              ...
              <form class="form" id="add_product_form">
                <div class="row mb-6">
                  ...
                  <div class="col-lg-10 fv-row">
                      <input type="text" name="phoneBrand" class="form-control form-control-lg form-control-solid" placeholder="Enter Phone Brand">
                  </div>
                </div>
                <div class="row mb-6">
                    <label class="col-lg-2 col-form-label fw-bold fs-6">Phone Brand Status</label>
                    <div class="col-lg-10 fv-row">
                        <select class="form-control selectpicker" name="phoneBrandStatus" id="phoneBrandStatus">
