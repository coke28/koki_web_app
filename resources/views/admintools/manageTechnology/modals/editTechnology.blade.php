<div class="modal fade" id="editTechnology" data-bs-backdrop="static" tabindex="-1" role="dialog"
  aria-labelledby="editTechnology" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content" id="technologyModalContent">
      ...
      <div class="modal-body">
        ...
        <form class="form" id="edit_technology_form">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" id="editTechnologySubmitBtn" class="btn btn-primary font-weight-bold">Edit
          Technology</button>
      </div>
      </form>
    </div>
