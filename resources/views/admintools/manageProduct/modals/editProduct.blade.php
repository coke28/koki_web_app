<div class="modal fade" id="edit_product_modal" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="edit_product_modal" aria-hidden="true">
        ...
        <div class="modal-content" id="productModalContent">
            ...
            <div class="modal-body">
              ...
              <div class="modal-footer">
                  ...
                  <button type="submit" id="editProductSubmitBtn" class="btn btn-primary font-weight-bold">Edit Product</button>
              </div>
            </form>
        </div>
    </div>
