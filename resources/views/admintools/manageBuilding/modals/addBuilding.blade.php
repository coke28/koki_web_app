<div class="modal fade" id="add_building_modal" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="add_building_modal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form" id="add_building_form">
                    <div class="row mb-6">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" id="addBuildingSubmitBtn" class="btn btn-primary font-weight-bold">Add Building</button>
            </div>
            </form>
        </div>
    </div>
