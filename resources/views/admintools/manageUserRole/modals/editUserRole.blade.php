<div class="modal fade" id="edit_user_role_modal" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="edit_user_role_modal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content" id="userRoleModalContent">
            ...
            <div class="modal-body">
              ...
              <form class="form" id="edit_user_role_form">
              ...
              <div class="modal-footer">
                  ...
                  <button type="submit" id="editUserRoleSubmitBtn" class="btn btn-primary font-weight-bold">Edit User Role</button>
              </div>
            </form>
        </div>
    </div>
