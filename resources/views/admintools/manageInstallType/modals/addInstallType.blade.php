<div class="modal fade" id="addInstallType" data-bs-backdrop="static" tabindex="-1" role="dialog"
  aria-labelledby="addInstallType" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form class="form" id="install_type_form">
          <div class="row mb-6">
          ...
          <div class="row mb-6">
            ...
            <div class="col-lg-10 fv-row">
              <input type="text" name="installTypeName" class="form-control form-control-lg form-control-solid"
      ...
      <div class="modal-footer">
        ...
        <button type="submit" id="addInstallTypeSubmitBtn" class="btn btn-primary font-weight-bold">Add Install
          Type</button>
      </div>
      </form>
    </div>
