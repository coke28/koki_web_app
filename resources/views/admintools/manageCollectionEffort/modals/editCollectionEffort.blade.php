<div class="modal fade" id="editCollectionEffort" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="editCollectionEffort" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content" id="collectionEffortModalContent">
            <div class="modal-header">
                <h5 class="modal-title">
                  <i class="bi bi-plus"></i>
                  Edit Collection Effort
                </h5>
                <!--begin::Close-->
            ...
            <div class="modal-body">
              ...
              <form class="form" id="edit_collection_effort_form">
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-10 fv-row">
                        <input type="text" name="collectionEffort" class="form-control form-control-lg form-control-solid" placeholder="Enter Collection Effort Name">
                    </div>
                  </div>
                <div class="row mb-6">
              ...
              <div class="modal-footer">
                  ...
                  <button type="submit" id="editCollectionEffortSubmitBtn" class="btn btn-primary font-weight-bold">Edit Collection Effort</button>
              </div>
            </form>
        </div>
    </div>
