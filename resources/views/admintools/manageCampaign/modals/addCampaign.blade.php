<div class="modal fade" id="addCampaign" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="addCampaign" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form" id="add_campaign_form">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" id="addCampaignSubmitBtn" class="btn btn-primary font-weight-bold">Add Status</button>
            </div>
            </form>
        </div>
    </div>
