<div class="modal fade" id="editReasonForDenial" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="editReasonForDenial" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content" id="reasonForDenialModalContent">
            <div class="modal-header">
                <h5 class="modal-title">
                  <i class="bi bi-plus"></i>
                  Edit Reason For Denial
                </h5>
                <!--begin::Close-->
            ...
            <div class="modal-body">
              ...
              <form class="form" id="edit_reason_for_denial_form">
              ...
              <div class="modal-footer">
                  ...
                  <button type="submit" id="editReasonForDenialSubmitBtn" class="btn btn-primary font-weight-bold">Edit Reason For Denial</button>
              </div>
            </form>
        </div>
    </div>
