<div class="modal fade" id="editCCRemark" data-bs-backdrop="static" tabindex="-1" role="dialog"
    aria-labelledby="editCCRemark" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content" id="ccRemarkModalContent">
            ...
            <div class="modal-body">
                ...
                <form class="form" id="edit_cc_remark_form">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" id="editCCRemarkSubmitBtn" class="btn btn-primary font-weight-bold">Edit
                    CC Remark</button>
            </div>
            </form>
        </div>
