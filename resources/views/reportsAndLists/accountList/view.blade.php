<x-base-layout>
    <div class="card card-custom">
      <div class="card-body">
            ...
            <div class="d-flex justify-content-end">
              ...
              <div class="d-flex align-items-center position-relative my-1 mb-2 mb-md-0 ">
                <div class="input-group input-group-solid">
                  ...
                  <input type="text" id="accountSearch" class="form-control form-control-lg form-control-solid"
                    placeholder="Search">
        ...
        <!--end::Wrapper-->
        <!--begin::Datatable-->
        <table id="account_dt" class="table table-rounded table-striped border gy-7 gs-7">
          <thead>
    ...
    <script type="text/javascript" src="{{ "/".'custom/accountListLauron/account_list_lauron_dt.js?v=' . rvndev()->getRandom(30)}}"></script>
