                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row">
                                            <select type="text" name="reason"
                                                ...
                                                <option>Reason Why Application Did Not Proceed To Online</option>
                                                <option></option>
                                            </select>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 fv-row">
                                <textarea style="height:75px;resize:none;" name="remarkStatus"
                                    class="form-control form-control-sm form-control-solid"
                                    placeholder="{{ $lead->callRemark }}"></textarea>
                            </div>
                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row">
                                            <input type="text" name="reference"
                                                class="form-control form-control-sm form-control-solid"
                                                placeholder="Reference" value="{{ $lead->referenceNumber }}" readonly>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row">
                                            <input type="text" name="customerName"
                                                class="form-control form-control-sm form-control-solid"
                                                placeholder="Customer Name" value="{{ $lead->customerName }}" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row">
                                            <input type="text" name="creditLimit"
                                                class="form-control form-control-sm form-control-solid"
                                                placeholder="Credit Limit" value="{{ $lead->creditLimit }}" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row">
                                            <input type="text" name="product"
                                                class="form-control form-control-sm form-control-solid"
                                                placeholder="Product" value="{{ $lead->product }}" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row">
                                            <input type="text" name="globeAccountNumber"
                                                class="form-control form-control-sm form-control-solid"
                                                placeholder="Globe Account #" value="{{ $lead->accountNumber }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row">
                                            <input type="text" id="addaccountBdate" name="birthday"
                                                class="form-control form-control-sm form-control-solid"
                                                placeholder="Birthday" value="{{$lead->birthday}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row">
                                            <input type="text" name="lname"
                                                class="form-control form-control-sm form-control-solid"
                                                placeholder="Last Name" value="{{ $lead->lastname }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row">
                                            <input type="text" name="fname"
                                                class="form-control form-control-sm form-control-solid"
                                                placeholder="First Name" value="{{ $lead->firstname }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row">
                                            <input type="text" name="mname"
                                                class="form-control form-control-sm form-control-solid"
                                                placeholder="Middle Name" value="{{ $lead->middle }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row" id="homeOwnership">
                                            <select class="form-select form-select-sm form-select-solid"
                                                name="homeOwnership">
                                                <option value="none">Select Home Ownership</option>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row">
                                            <input type="text" name="houseBuilding"
                                                class="form-control form-control-sm form-control-solid"
                                                placeholder="House/Building" value="{{ $lead->addHB }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row">
                                            <input type="text" name="unitNumber"
                                                class="form-control form-control-sm form-control-solid"
                                                placeholder="Unit #" value="{{ $lead->addUnit }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row">
                                            <input type="text" name="buildingVillage"
                                                class="form-control form-control-sm form-control-solid"
                                                placeholder="Building/Village" value="{{ $lead->addBuilding }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row">
                                            <input type="text" name="addressStreet"
                                                class="form-control form-control-sm form-control-solid"
                                                placeholder="Address Street Name" value="{{ $lead->addStreet }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row">
                                            <input type="text" name="addressBarangay"
                                                class="form-control form-control-sm form-control-solid"
                                                placeholder="Address Baranagay" value="{{ $lead->addBarangay }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row">
                                            <input type="text" name="addressCity"
                                                class="form-control form-control-sm form-control-solid"
                                                placeholder="Address City" value="{{ $lead->addCity }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row">
                                            <input type="text" name="addressProvince"
                                                class="form-control form-control-sm form-control-solid"
                                                placeholder="Address Province" value="{{ $lead->addProvince }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row">
                                            <input type="text" name="addressPostal"
                                                class="form-control form-control-sm form-control-solid"
                                                placeholder="Address Postal" value="{{ $lead->addPostal }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row">
                                            <input type="text" name="addressRegion"
                                                class="form-control form-control-sm form-control-solid"
                                                placeholder="Address Region" value="{{ $lead->addressRegion }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row">
                                            <input type="text" style="height:75px;resize:none;" name="addressRemark"
                                                class="form-control form-control-sm form-control-solid"
                                                placeholder="Remark for the Address" value="{{ $lead->address }}"></input>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row">
                                            <input type="text" name="lengthOfStay"
                                                class="form-control form-control-sm form-control-solid"
                                                placeholder="Length Of Stay" value="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row">
                                            <input type="text" name="landlineContactNumber"
                                                class="form-control form-control-sm form-control-solid"
                                                placeholder="Landline #" value="{{ $lead->landline }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row">
                                            <input type="text" name="existingMobileNumber"
                                                class="form-control form-control-sm form-control-solid"
                                                placeholder="Existing Mobile #" value="{{ $lead->mobileNumber }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row">
                                            <input type="text" name="mobileNumber"
                                                class="form-control form-control-sm form-control-solid"
                                                placeholder="Mobile #" value="{{ $lead->mobileNumber }}" readonly>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row">
                                            <input type="text" name="email"
                                                class="form-control form-control-sm form-control-solid"
                                                placeholder="ex. johndoe@hotmail.com" value="{{ $lead->email }}">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row" id="billingType">
                                            <select class="form-select form-select-sm form-select-solid"
                                                name="billingType">
                                                <option value="none">Select Billing Type</option>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row">
                                            <input type="text" name="referenceID"
                                                class="form-control form-control-sm form-control-solid"
                                                placeholder="Reference ID" value="{{ $lead->referenceID }}" readonly>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row">
                                            <input type="text" name="agentName"
                                                class="form-control form-control-sm form-control-solid"
                                                placeholder="Agent Name" value="{{ $lead->agent }}" readonly>
                                        </div>
                                    </div>
                                    {{-- <div class="col-lg-6">
                                        <label for="product" class="col-form-label fw-bold fs-6">Product</label>
                                        <div class="col-lg-12 fv-row">
                                            <input type="text" name="product"
                                                class="form-control form-control-sm form-control-solid"
                                                placeholder="Product" value="{{ $lead->product }}">
                                        </div>
                                    </div> --}}
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row" id="planType">
                                            <select class="form-select form-select-sm form-select-solid"
                                                ...
                                                <option {{ $lead->planType ==""? 'selected':''}} value="none">Select Plan Type</option>
                                                <option {{ $lead->planType =="GPLAN With Device"? 'selected':''}} value="GPLAN With Device">GPLAN With Device</option>
                                                <option {{ $lead->planType =="GPLAN With GCASH"? 'selected':''}} value="GPLAN With GCASH">GPLAN With GCASH</option>
                                                <option {{ $lead->planType =="GPLAN Plus"? 'selected':''}} value="GPLAN Plus">GPLAN Plus</option>
                                                <option {{ $lead->planType =="GPLAN With SIM Only"? 'selected':''}} value="GPLAN With SIM Only">GPLAN With SIM Only</option>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row" id="handset">
                                            <select class="form-select form-select-sm form-select-solid" name="handset">
                                                <option value="none">Select Phone Model</option>
                                                @foreach($phones as $phone)
                                                <option value="{{ $phone->phoneModel }}"> {{ $phone->phoneModel }}
                                                </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row">
                                            <input type="text" name="promo"
                                                class="form-control form-control-sm form-control-solid"
                                                placeholder="Promo" value="{{ $lead->promoToOffer }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row" id="modeOfPayment">
                                            <select class="form-select form-select-sm form-select-solid"
                                                ...
                                                <option value="{{ $paymentMethod->merchant }}">{{
                                                    $paymentMethod->merchant }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row" id="LockUpPeriod">
                                            <select class="form-select form-select-sm form-select-solid"
                                                name="LockUpPeriod">
                                                <option value="none">Select Lockup Period</option>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row" id="transmittalType">
                                            <select class="form-select form-select-sm form-select-solid"
                                                ...
                                                <option value="none">Select Transmittal Type</option>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row" id="sourceOfSales">
                                            <select class="form-select form-select-sm form-select-solid"
                                                name="sourceOfSales">
                                                <option value="none">Select Source Of Sales</option>
                                                <option value="BAU Referral">BAU Referral</option>
                                                <option value="FB Page">FB Page</option>
                                                <option value="GCASH MILO 2">GCASH MILO 2</option>
                                                <option value="GLBB PQ">GLBB PQ</option>

                                                <option value="HVP">HVP</option>
                                                <option value="HVP Referal">HVP Referal</option>
                                                <option value="Lukewarm Leads">Lukewarm Leads</option>
                                                <option value="Lukewarm Referral">Lukewarm Referral</option>

                                                <option value="Multi PQ">Multi PQ</option>
                                                <option value="Multi PQ_BAU">Multi PQ_BAU</option>
                                                ...
                                                <option value="Schedule a Call Leads">Schedule a Call Leads</option>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row" id="applicationMode">
                                            <select class="form-select form-select-sm form-select-solid"
                                                ...
                                                <option value="none">Select Application Mode</option>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row">
                                            <textarea style="height:75px;resize:none;" name="remark"
                                                class="form-control form-control-sm form-control-solid"
                                                placeholder="" value="{{ $lead->remark }}"></textarea>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row" id="salesChannel">
                                            <select class="form-select form-select-sm form-select-solid"
                                                name="salesChannel">
                                                <option value="none">Select Sales Channel</option>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row" id="projectPromo">
                                            <select class="form-select form-select-sm form-select-solid"
                                                ...
                                                <option value="{{ $promoName->statusName }}">{{ $promoName->statusName }}</option>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row" id="appsReceivedSource">
                                            <select class="form-select form-select-sm form-select-solid"
                                                ...
                                                <option value="none">Select Apps  Received Source</option>
                                                <option value="BDO Policy">BDO Policy</option>
                                                <option value="Credit Card AS POFC">Credit Card AS POFC</option>
                                                <option value="Policy Exemption 500 Below CL">Policy Exemption 500 Below CL</option>
                                                <option value="Semi Monthly Payslip">Semi Monthly Payslip</option>
                                                <option value="BPO Policy/ Semi Monthly Payslip">BPO Policy/ Semi Monthly Payslip</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row" id="poidType">
                                            <select class="form-select form-select-sm form-select-solid"
                                                name="poidType">
                                                <option value="none">Select POID Type</option>
                                                <option value="PRC ID">PRC ID</option>
                                                <option value="(AMOSUP) Dependant's Card">(AMOSUP) Dependant's Card</option>
                                                <option value="(OWWA) ID">(OWWA) ID</option>
                                                <option value="Banana Grower Association">Banana Grower Association</option>
                                                <option value="Company ID">Company ID</option>
                                                <option value="Driver's License/Computer-Generated">Driver's License/Computer-Generated</option>
                                                <option value="Firearms License">Firearms License</option>
                                                <option value="GSIS/GSIS ECARD PLUS">GSIS/GSIS ECARD PLUS</option>
                                                <option value="HOME DEVELOPMENT MUTUAL FUNDS (HDMI)">HOME DEVELOPMENT MUTUAL FUNDS (HDMI)</option>
                                                <option value="INTEGRATED BAR OF THE PHIL (IBP)">INTEGRATED BAR OF THE PHIL (IBP)</option>
                                                <option value="National ID">National ID</option>
                                                <option value="NBI Clearance">NBI Clearance</option>
                                                <option value="OFW ID">OFW ID</option>
                                                <option value="Pagibig Loyalty Card">Pagibig Loyalty Card</option>
                                                <option value="Passport">Passport</option>
                                                <option value="PHILHEALTH ID">PHILHEALTH ID</option>
                                                <option value="Philippine Medical Association">Philippine Medical Association</option>
                                                <option value="Philippine Secretaries Association">Philippine Secretaries Association</option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row" id="leadType">
                                            <select class="form-select form-select-sm form-select-solid"
                                                name="leadType" selected="{{ $lead->leadType }}">
                                                <option {{ $lead->leadType ==""? 'selected':''}} value="">Select Lead Type</option>
                                                <option {{ $lead->leadType =="BANANA SPLIT"? 'selected':''}} value="BANANA SPLIT">Banana Split</option>
                                                <option {{ $lead->leadType =="BAU-GLBB PQ"? 'selected':''}} value="BAU-GLBB PQ">BAU-GLBB PQ</option>
                                                <option {{ $lead->leadType =="BW LEADS GEN"? 'selected':''}} value="BW LEADS GEN">BW LEADS GEN</option>
                                                <option {{ $lead->leadType =="HVP"? 'selected':''}} value="HVP">HVP</option>
                                                <option {{ $lead->leadType =="LUKEWARM"? 'selected':''}} value="LUKEWARM">Lukewarm</option>
                                                <option {{ $lead->leadType =="MINI APP"? 'selected':''}} value="MINI APP">Mini APP</option>
                                                <option {{ $lead->leadType =="MNP"? 'selected':''}} value="MNP">MNP</option>
                                                <option {{ $lead->leadType =="OLFO_RTS"? 'selected':''}} value="OLFO_RTS">OLFO_RTS</option>
                                                <option {{ $lead->leadType =="ONLINE FALL OUT"? 'selected':''}} value="ONLINE FALL OUT">Online Fall Out</option>
                                                <option {{ $lead->leadType =="PLATINUM"? 'selected':''}} value="PLATINUM">Platinum</option>
                                                <option {{ $lead->leadType =="REFERRAL"? 'selected':''}} value="REFERRAL">Referral</option>
                                                <option {{ $lead->leadType =="SALMON"? 'selected':''}} value="SALMON">Salmon</option>
                                                <option {{ $lead->leadType =="SANITIZED-GLBB PQ"? 'selected':''}} value="SANITIZED-GLBB PQ">Sanitized-GLBB PQ</option>
                                                <option {{ $lead->leadType =="SANITIZED-MULTI PQ"? 'selected':''}} value="SANITIZED-MULTI PQ">Sanitized-MULTI PQ</option>
                                                <option {{ $lead->leadType =="SCHEDULE A CALL"? 'selected':''}} value="SCHEDULE A CALL">Schedule A Call</option>
                                                <option {{ $lead->leadType =="SIERRA"? 'selected':''}} value="SIERRA">Sierra</option>
                                                <option {{ $lead->leadType =="PLAYBACK"? 'selected':''}} value="PLAYBACK">Playback</option>
                                      
{{--                                            
                                                <option value="BAU-MULTI PQ">BAU-MULTI PQ</option>
                                                <option value="BW LEADS GEN">BW LEADS GEN</option>
                                                <option value="HVP">HVP</option>
                                                <option value="LUKEWARM">Lukewarm</option>
                                                <option value="MILO PHASE 2">MILO Phase 2</option>
                                                <option value="MINI APP">Mini APP</option>
                                                <option value="MNP">MNP</option>
                                                <option value="OLFO_RTS">OLFO_RTS</option>
                                                <option value="ONLINE FALL OUT">Online Fall Out</option>
                                                <option value="PLATINUM">Platinum</option>
                                                <option value="REFERRAL">Referral</option>
                                                <option value="SALMON">Salmon</option>
                                                <option value="SANITIZED-GLBB PQ">Sanitized-GLBB PQ</option>
                                                <option value="SANITIZED-MULTI PQ">Sanitized-MULTI PQ</option>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row">
                                            <input type="text" name="applicationDate"
                                                class="form-control form-control-sm form-control-solid"
                                                placeholder="Application Date" value="{{ $lead->appDate }}">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row" id="GDFPromo">
                                            <select class="form-select form-select-sm form-select-solid"
                                                name="GDFPromo">
                                                <option value="none">Select GDF Promo Tag</option>
                                                <option value="DOCS-200">DOCS-200</option>
                                                <option value="LEADS GEN - 200">LEADS GEN - 200</option>
                                                <option value="LEADS GEN - 400">LEADS GEN - 400</option>
                                                <option value="NO GDF (NOT OFFERED)">NO GDF (NOT OFFERED)</option>
                                                <option value="Remarketing - 200">Remarketing - 200</option>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row">
                                            <input type="text" name="dateCalled"
                                                class="form-control form-control-sm form-control-solid"
                                                placeholder="Date Called" value="{{ $currentDatestamp }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 fv-row">
                                            <input type="text" name="portingNumber"
                                                class="form-control form-control-sm form-control-solid"
                                                placeholder="Porting #" value="{{ $lead->port }}">
                                        </div>
                                    </div>
