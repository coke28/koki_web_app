<div class="modal fade" id="edit_batch_modal" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="edit_batch_modal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content" id="batchModalContent">
            ...
            <div class="modal-body">
              ...
              <form class="form" id="edit_batch_form">
              ...
              <div class="modal-footer">
                  ...
                  <button type="submit" id="editBatchSubmitBtn" class="btn btn-primary font-weight-bold">Edit Batch</button>
              </div>
            </form>
        </div>
    </div>
