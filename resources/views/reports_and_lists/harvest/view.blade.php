<x-base-layout>
            ...
            {{-- <div class="d-flex align-items-center position-relative my-1 mb-2 mb-md-0 w-50 p-4">
              <div class="input-group flex-nowrap">
                ...
                <div class="overflow-hidden flex-grow-1">
                  <select id="harvestSelect" class="form-select rounded-start-0" data-control="select" data-placeholder="Select an option">
            ...
            <div class="d-flex justify-content-end">
              ...
              <div class="d-flex align-items-center position-relative my-1 mb-2 mb-md-0 ">
                <div class="input-group input-group-solid">
                  ...
                  <input type="text" id="harvestSearch" class="form-control form-control-lg form-control-solid"
                    placeholder="Search">
    ...
    @section('scripts')
    <script type="text/javascript" src="{{ "/".'custom/listHarvest/list_harvest_dt.js?v='. rvndev()->getRandom(30) }}"></script>
    <script type="text/javascript" src="{{ "/".'custom/listHarvest/delete_harvest.js?v='. rvndev()->getRandom(30) }}"></script>
