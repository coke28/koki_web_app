    ...
    {{-- <h1>Manage User</h1> --}}
      <div class="card card-custom">
        <div class="card-body">
          ...
          <div class="d-flex flex-stack mb-5">
              ...
              <div class="d-flex align-items-center position-relative my-1 mb-2 mb-md-0">
                  <div class="input-group input-group-solid">
                      ...
                      <input type="text" id="receiptSearch" class="form-control form-control-lg form-control-solid" placeholder="Search">
              ...
              {{-- <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                  ...
                  <button type="button" class="btn btn-primary" title="Add user" data-bs-toggle="modal" data-bs-target="#add_user_modal">
          ...
          <!--end::Wrapper-->
          <!--begin::Datatable-->
          <table id="receipt_dt" class="table table-rounded table-striped border gy-7 gs-7">
              <thead>
      ...
      @section('scripts')
        ...
        <script type="text/javascript" src="{{ "/".'custom/listReceipt/list_receipt_dt.js?v='. rvndev()->getRandom(30) }}"></script>
