<x-base-layout>
    <div class="card card-custom">
      <div class="card-body">
          ...
          <div class="d-flex justify-content-end">
            ...
            <div class="d-flex align-items-center position-relative my-1 mb-2 mb-md-0 ">
              <div class="input-group input-group-solid">
                ...
                <input type="text" id="hotLeadSearch" class="form-control form-control-lg form-control-solid"
                  placeholder="Search">
        ...
        <!--end::Wrapper-->
        <!--begin::Datatable-->
        <table id="hotlead_dt" class="table table-rounded row-border border gy-7 gs-7">
          <thead>
    ...
    @section('scripts')
    <script type="text/javascript" src="{{ "/".'custom/agent/hotLead/hotlead_dt.js?v='. rvndev()->getRandom(30) }}"></script>
    @endsection
