    ...
    @csrf
        ...
        <div class="text-center mb-10">
            ...
            <h1 class="text-dark mb-3">
                {{ __('Sign In') }}<br><br> <img src="{{ asset('demo1/media/logos/terra_huevos.jpg') }}" class="h-150px logo">
        ...
        <!--end::Input group-->
          ...
          <div class="fv-row mb-10">
            ...
            <!--begin::Input-->
            <input class="form-control form-control-lg form-control-solid" type="text" name="username" autocomplete="off" required autofocus/>
            <!--end::Input-->
        </div>
        <!--end::Input group-->
